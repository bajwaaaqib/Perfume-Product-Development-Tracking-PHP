...
<div class="container my-5">
    <h2 class="mb-4 text-center fw-bold text-primary">All Perfume Products</h2>
...
<tbody>
    <?php if (count($products) > 0): ?>
        ...
        <?php foreach ($products as $product): ?>
            <tr class="text-center">
                <td><?= $counter++ ?></td>  <!-- Sequential number instead of product id -->
    ...
    <?php else: ?>
        <tr>
            <td colspan="10" class="text-center text-muted py-4 fs-5">No products found.</td>
        </tr>
    <?php endif ?>
</tbody>
...
function handleAction(select, productId) {
    ...
    if (action === "edit") {
        ...
        // Delete immediately without confirmation as you requested
